...
{
    class ObjectPeriodicSound : ObjectSound
    {
        ...
        SR1_Primative<byte> onTime = new SR1_Primative<byte>();
        SR1_Primative<byte> onTimeVariation = new SR1_Primative<byte>();
        SR1_Primative<byte> offTime = new SR1_Primative<byte>();
        SR1_Primative<byte> offTimeVariation = new SR1_Primative<byte>();
        ...
        protected override void ReadMembers(SR1_Reader reader, SR1_Structure parent)
        {
            ...
            onTime.Read(reader, this, "onTime");
            onTimeVariation.Read(reader, this, "onTimeVariation");
            offTime.Read(reader, this, "offTime");
            offTimeVariation.Read(reader, this, "offTimeVariation");
        ...
        public override void WriteMembers(SR1_Writer writer)
        {
            ...
            onTime.Write(writer);
            onTimeVariation.Write(writer);
            offTime.Write(writer);
            offTimeVariation.Write(writer);
            sfxIDs.Write(writer);
        }
    }
}
