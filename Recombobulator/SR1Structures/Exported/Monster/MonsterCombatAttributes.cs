...
namespace Recombobulator.SR1Structures
{
	public class MonsterCombatAttributes : SR1_Structure
	{
		...
		protected override void ReadMembers(SR1_Reader reader, SR1_Structure parent)
		{
			...
			enemyAttackRange.Read(reader, this, "enemyAttackRange", SR1_File.Version.May12, SR1_File.Version.Next);
			SR1_Structure temp = reader.File._Structures[reader.Object.data.Offset];
			enemyRunAttackRange.Read(reader, this, "enemyRunAttackRange", SR1_File.Version.Jul14, SR1_File.Version.Next);
			preferredCombatRange.Read(reader, this, "preferredCombatRange", SR1_File.Version.Jul14, SR1_File.Version.Next);
			suckPower.Read(reader, this, "suckPower", SR1_File.Version.May12, SR1_File.Version.Next);
			suckRange.Read(reader, this, "suckRange", SR1_File.Version.May12, SR1_File.Version.Next);
			suckTime.Read(reader, this, "suckTime", SR1_File.Version.Jun10, SR1_File.Version.Next);
		...
		public override void WriteMembers(SR1_Writer writer)
		{
			...
			enemyAttackRange.Write(writer, SR1_File.Version.May12, SR1_File.Version.Next);
			enemyRunAttackRange.Write(writer, SR1_File.Version.Jul14, SR1_File.Version.Next);
			preferredCombatRange.Write(writer, SR1_File.Version.Jul14, SR1_File.Version.Next);
			suckPower.Write(writer, SR1_File.Version.May12, SR1_File.Version.Next);
			suckRange.Write(writer, SR1_File.Version.May12, SR1_File.Version.Next);
			suckTime.Write(writer, SR1_File.Version.Jun10, SR1_File.Version.Next);
