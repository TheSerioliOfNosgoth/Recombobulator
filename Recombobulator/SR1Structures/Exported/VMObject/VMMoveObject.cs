...
namespace Recombobulator.SR1Structures
{
	class VMMoveObject : VMObject
	{
		...
		protected override void ReadReferences(SR1_Reader reader, SR1_Structure parent)
		{
			...
			{
				new SR1_StructureArray<VMMoveOffset>(numVMOffsets.Value).ReadFromPointer(reader, vmoffsetList);
				new SR1_StructureArray<VMMoveVertex>(numVMVertices.Value).ReadFromPointer(reader, vmvertexList);
