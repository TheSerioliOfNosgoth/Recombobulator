...
namespace Recombobulator.SR1Structures
{
	public class Level : SR1_Structure
	{
		...
		public override void WriteMembers(SR1_Writer writer)
		{
			...
			gexStartPosition.Write(writer);
			collectableCount0.Write(writer);
			collectableCount1.Write(writer);
			collectableCount2.Write(writer);
			farColorR.Write(writer);
			farColorG.Write(writer);
			farColorB.Write(writer);
			cpad0.Write(writer);
			backColorR.Write(writer);
			backColorG.Write(writer);
			backColorB.Write(writer);
			cpad1.Write(writer);
			objectFarColorR.Write(writer);
			objectFarColorG.Write(writer);
			objectFarColorB.Write(writer);
			...
			brotherUnitsNames.Write(writer);
			unknown0.Write(writer);
			currentCollectable.Write(writer);
