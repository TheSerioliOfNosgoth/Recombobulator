...
namespace TreeList
{
	...
	public class TreeListView : Control, ISupportInitialize
	{
		...
		public global::TreeList.HitInfo CalcColumnHit(Point mousepoint)
		{
		...
		protected override void OnMouseMove(MouseEventArgs e)
		{
			...
			global::TreeList.HitInfo info = Columns.CalcHitInfo(new Point(e.X, e.Y), HScrollValue());
		...
		protected override CreateParams CreateParams
		{
			get
			{
				...
				p.Style &= ~(int)global::TreeList.WinUtil.WS_BORDER;
				p.ExStyle &= ~(int)global::TreeList.WinUtil.WS_EX_CLIENTEDGE;
		...
		protected virtual global::TreeList.TreeList.TextFormatting GetFormatting(global::TreeList.Node node, global::TreeList.TreeListColumn column)
		{
